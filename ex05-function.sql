...
SELECT REPLACE('JAKE and JUE', 'J', 'BL') FROM dual;
...
날짜 연산
    ...
    두 날짜 사이의 일수를 알아내기 위해 뺴기연산을 합니다.
*/
...
*/
SELECT last_name, TO DATE(hire_date, 'YYYY/MM/DD HH24:MI:SS') AS HIREDATE
FROM employees;
...
-- NULLIF() 함수
-- 두 표현식을 비교하고 같으면 null을 반환하고 다르면 exprl을 반환합니다.
-- 그러나 exprl에 대해 리터럴 NULL을 지정할 수 없습니다.
